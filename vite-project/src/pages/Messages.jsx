      ...
      {showLoading ? (
        <div className="h-full flex items-center justify-center">
          <div className="text-center">
            <MessageSquare className="h-12 w-12 text-blue-500 mb-4 mx-auto" />
            <h3 className="font-medium text-lg mb-2">Loading chat...</h3>
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <button
            className="md:hidden fixed bottom-4 right-4 z-10 bg-blue-500 text-white rounded-full p-3 shadow-lg hover:bg-blue-600 transition-colors"
            ...
            {activeContactId ? (
              ...
              <div className="h-full flex items-center justify-center bg-gray-50 text-gray-500">
                <div className="text-center p-6">
                  ...
                  <p>Choose a contact from the sidebar or create a new AI assistant to start chatting</p>
                </div>
              </div>
            )}
          </div>
